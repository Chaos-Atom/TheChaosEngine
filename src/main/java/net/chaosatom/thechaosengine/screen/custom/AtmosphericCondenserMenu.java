...
public class AtmosphericCondenserMenu extends AbstractContainerMenu {
    public final AtmosphericCondenserBlockEntity blockEntity;
    ...
    public int getScaledEffectiveness(int meterHeightPixelSize) {
        ...
        if (clampedEffectiveness <= 0) {
            return 0;
        }

        return maxEffectiveness != 0 ? (clampedEffectiveness * meterHeightPixelSize) / maxVisualEffectiveness : 0;
    }
