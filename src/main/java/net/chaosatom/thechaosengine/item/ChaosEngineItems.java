...
public class ChaosEngineItems {
    ...
    public static final DeferredItem<Item> ASSEMBLY_HOUSING = ITEMS.register("assembly_housing",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> CONTROL_ASSEMBLY = ITEMS.register("control_assembly",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> MOTOR_ASSEMBLY = ITEMS.register("motor_assembly",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> REFINING_ASSEMBLY = ITEMS.register("refining_assembly",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> IGNITION_ASSEMBLY = ITEMS.register("ignition_assembly",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> SOLAR_PANEL_UNIT = ITEMS.register("solar_panel_unit",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> INDUSTRIAL_WHISK = ITEMS.register("industrial_whisk",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> SIMPLE_MOTOR = ITEMS.register("simple_motor",
            () -> new Item(new Item.Properties()));
