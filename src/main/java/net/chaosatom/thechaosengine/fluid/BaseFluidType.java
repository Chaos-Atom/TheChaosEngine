...
public class BaseFluidType extends FluidType{
    ...
    public BaseFluidType(final ResourceLocation stillTexture, final ResourceLocation flowingTexture, final ResourceLocation overlayTexture,
                         final int tintColor, final Vector3f fogColor, final float fogStartDistance, final float fogEndDistance, final FluidType.Properties properties) {
        super(properties);
    ...
    public IClientFluidTypeExtensions getClientFluidTypeExtensions() {
        return new IClientFluidTypeExtensions() {
            ...
            public void modifyFogRender(Camera camera, FogRenderer.FogMode mode, float renderDistance, float partialTick,
                ...
                RenderSystem.setShaderFogStart(BaseFluidType.this.fogStartDistance);
                RenderSystem.setShaderFogEnd(BaseFluidType.this.fogEndDistance); // distance when the fog starts
            }
        };
    }
}
